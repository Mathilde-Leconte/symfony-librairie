...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\AdimBookController' => 'getAdimBookControllerService',
            'App\\Controller\\AdminAuthorController' => 'getAdminAuthorControllerService',
            'App\\Controller\\AdminBookCategoryController' => 'getAdminBookCategoryControllerService',
            'App\\Controller\\AdminBookPageController' => 'getAdminBookPageControllerService',
            'App\\Controller\\AdminCarouselController' => 'getAdminCarouselControllerService',
            'App\\Controller\\AdminDashboardController' => 'getAdminDashboardControllerService',
            'App\\Controller\\AdminHomeController' => 'getAdminHomeControllerService',
            'App\\Controller\\FrontHomeController' => 'getFrontHomeControllerService',
            ...
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.authors' => 'getSmartUniqueNamer_AuthorsService',
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.bookpages' => 'getSmartUniqueNamer_BookpagesService',
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.books' => 'getSmartUniqueNamer_BooksService',
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.carousels' => 'getSmartUniqueNamer_CarouselsService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('yh8tDcAkq-', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8DMas17RBC', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5SM-6cu47d', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['url' => $this->getEnv('resolve:DATABASE_URL'), 'driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'defaultTableOptions' => []], $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'vich_uploader.listener.clean.authors' => ['privates', 'vich_uploader.listener.clean.authors', 'getVichUploader_Listener_Clean_AuthorsService', true],
            'vich_uploader.listener.clean.bookpages' => ['privates', 'vich_uploader.listener.clean.bookpages', 'getVichUploader_Listener_Clean_BookpagesService', true],
            'vich_uploader.listener.clean.books' => ['privates', 'vich_uploader.listener.clean.books', 'getVichUploader_Listener_Clean_BooksService', true],
            'vich_uploader.listener.clean.carousels' => ['privates', 'vich_uploader.listener.clean.carousels', 'getVichUploader_Listener_Clean_CarouselsService', true],
            'vich_uploader.listener.remove.authors' => ['privates', 'vich_uploader.listener.remove.authors', 'getVichUploader_Listener_Remove_AuthorsService', true],
            'vich_uploader.listener.remove.bookpages' => ['privates', 'vich_uploader.listener.remove.bookpages', 'getVichUploader_Listener_Remove_BookpagesService', true],
            'vich_uploader.listener.remove.books' => ['privates', 'vich_uploader.listener.remove.books', 'getVichUploader_Listener_Remove_BooksService', true],
            'vich_uploader.listener.remove.carousels' => ['privates', 'vich_uploader.listener.remove.carousels', 'getVichUploader_Listener_Remove_CarouselsService', true],
            'vich_uploader.listener.upload.authors' => ['privates', 'vich_uploader.listener.upload.authors', 'getVichUploader_Listener_Upload_AuthorsService', true],
            'vich_uploader.listener.upload.bookpages' => ['privates', 'vich_uploader.listener.upload.bookpages', 'getVichUploader_Listener_Upload_BookpagesService', true],
            'vich_uploader.listener.upload.books' => ['privates', 'vich_uploader.listener.upload.books', 'getVichUploader_Listener_Upload_BooksService', true],
            'vich_uploader.listener.upload.carousels' => ['privates', 'vich_uploader.listener.upload.carousels', 'getVichUploader_Listener_Upload_CarouselsService', true],
        ], [
            ...
            'vich_uploader.listener.clean.authors' => '?',
            'vich_uploader.listener.clean.bookpages' => '?',
            'vich_uploader.listener.clean.books' => '?',
            'vich_uploader.listener.clean.carousels' => '?',
            'vich_uploader.listener.remove.authors' => '?',
            'vich_uploader.listener.remove.bookpages' => '?',
            'vich_uploader.listener.remove.books' => '?',
            'vich_uploader.listener.remove.carousels' => '?',
            'vich_uploader.listener.upload.authors' => '?',
            'vich_uploader.listener.upload.bookpages' => '?',
            'vich_uploader.listener.upload.books' => '?',
            'vich_uploader.listener.upload.carousels' => '?',
        ]), [0 => 'vich_uploader.listener.clean.carousels', 1 => 'vich_uploader.listener.clean.bookpages', 2 => 'vich_uploader.listener.clean.books', 3 => 'vich_uploader.listener.clean.authors', 4 => 'doctrine.orm.messenger.doctrine_schema_subscriber', 5 => 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber', 6 => 'doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber', 7 => 'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber', 8 => 'vich_uploader.listener.remove.carousels', 9 => 'vich_uploader.listener.upload.carousels', 10 => 'vich_uploader.listener.remove.bookpages', 11 => 'vich_uploader.listener.upload.bookpages', 12 => 'vich_uploader.listener.remove.books', 13 => 'vich_uploader.listener.upload.books', 14 => 'vich_uploader.listener.remove.authors', 15 => 'vich_uploader.listener.upload.authors', 16 => [0 => [0 => 'loadClassMetadata'], 1 => 'doctrine.orm.default_listeners.attach_entity_listeners']]), []);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\BookCategoryRepository' => ['privates', 'App\\Repository\\BookCategoryRepository', 'getBookCategoryRepositoryService', true],
            'App\\Repository\\BookPageRepository' => ['privates', 'App\\Repository\\BookPageRepository', 'getBookPageRepositoryService', true],
            ...
            'App\\Repository\\BookCategoryRepository' => '?',
            'App\\Repository\\BookPageRepository' => '?',
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yqOx3wfge1', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('YENl-nqST8', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+SH0pKm6WR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('f-nFH9vakV', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4SOIIbGQzn', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AzNAtfqX1q', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'vich_uploader.mappings' => [
                'carousels' => [
                    'uri_prefix' => '/images/carousels',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/carousels'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.carousels',
                        'options' => [
                ...
                'bookpages' => [
                    'uri_prefix' => '/images/cbook-pages',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/book-pages'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.bookpages',
                        'options' => [
                ...
                'books' => [
                    ...
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/books'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.books',
                        'options' => [
                ...
                'authors' => [
                    ...
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/authors'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.authors',
                        'options' => [
